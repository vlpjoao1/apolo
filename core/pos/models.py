...
class Company(models.Model):
    ...
    rif = models.CharField(max_length=15, unique=True, verbose_name='Número de Rif')
    address = models.CharField(max_length=150, null=True, blank=True, verbose_name='Dirección')
    mobile = models.CharField(max_length=11, verbose_name='Teléfono celular')
    phone = models.CharField(max_length=11, verbose_name='Teléfono de casa')
